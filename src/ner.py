...
def main(args=None):
    ...
    clinical_descriptions = load_clinical_descriptions(
        args.clinical_descriptions)
    print(len(clinical_descriptions.keys()))

    tag_sentences(clinical_descriptions, model,
                  tokenizer, args.output_path, config)
...
def parse_args(args):
    ...
    parser.add_argument('--clinical_descriptions',
                        help='Path to the clinical descriptions to label', type=str)
